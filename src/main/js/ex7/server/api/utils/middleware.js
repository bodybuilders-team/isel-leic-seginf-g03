...
const jwt = require('./async-jsonwebtoken.js');
// More info at: https://github.com/auth0/node-jsonwebtoken ; https://jwt.io/#libraries
...
module.exports = async function (database) {
     ...
     * Authorizes the user.
     *
     * @param resource the resource which the user wants to access
     * @param action the action which the user wants to perform on the resource
     *
     * @returns {*} the middleware function that performs the authorization
     */
